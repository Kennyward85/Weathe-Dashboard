...
function getData() {
    ...
    $.ajax({
        ...
        $.ajax({
            url: "https://api.openweathermap.org/data/2.5/uvi?appid=70d33a5bb880c7ea27d6d510a14fac55&lat=" + lat + "&lon=" + lon,
            method: "GET"
        ...
        $.ajax({
            url: "https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&appid=70d33a5bb880c7ea27d6d510a14fac55",
            method: "GET"
